...
$sql = "SELECT flag FROM flags WHERE vulnerability = 'securityMisconfig'";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if (hash_equals($hashedFlag, $storedFlag)) {
        $matchedFlag = true;
        echo "Success! The entered flag matches the vulnerability: securityMisconfig";
        break;
    }
}

if (!$matchedFlag) {
    echo "Failure! The entered flag does not match the vulnerability: securityMisconfig";
}
