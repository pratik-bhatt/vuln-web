...
$sql = "SELECT flag FROM flags WHERE vulnerability = 'AutoThreats'";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if (hash_equals($hashedFlag, $storedFlag)) {
        $matchedFlag = true;
        echo "Success! The entered flag matches the vulnerability: AutoThreats";
        break;
    }
}

if (!$matchedFlag) {
    echo "Failure! The entered flag does not match the vulnerability: AutoThreats";
}
